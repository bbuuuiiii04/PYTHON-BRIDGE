...
validation_scope: software-only plus Rekordbox 7.2.11 passive mixer RE evidence routing and static CFX/filter candidate routing; hardware-output unvalidated
---
