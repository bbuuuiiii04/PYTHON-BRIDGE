...
| AWR-116 | 2026-07-03 audit fix queue | `docs/plans/active/audit_2026_07_03_fix_queue_spec.md` | Ordered Codex implementation queue P1-P4. P1 and P2 are committed; P3 is software-tested in the working queue for Govee handoff threading, ANLZ read-failure recovery, raw elapsed OS2L sends, and spectral-cache eviction startup. Software-only; no bridge restart, live process, SoundSwitch, Rekordbox, laser, LED/Govee, MIDI, DMX, Enttec, or hardware action is authorized by the spec alone. |
