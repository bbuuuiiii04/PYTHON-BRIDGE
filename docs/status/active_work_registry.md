...
| AWR-107 | SoundSwitch static exporter / bridge-native player | `docs/plans/active/soundswitch_exporter_remaining_work.md`, `docs/plans/active/soundswitch_perfect_parity_finisher_spec.md`, `docs/plans/active/soundswitch_parity_evidence_finisher_spec.md`, `docs/prompts/active/soundswitch_truth_exam_fable_fix_prompt.md`, `docs/plans/active/soundswitch_README.md`, `docs/research/soundswitch/README.md`, `docs/architecture/native_autoloop_pack_authority.md`, `docs/plans/active/native_autoloop_dmx_runtime_spec.md`, `docs/plans/active/soundswitch_autoloop_equivalence_oracle_spec.md`, `docs/plans/active/soundswitch_witness_auto_retire_spec.md`, `docs/plans/active/soundswitch_pack_live_readiness_spec.md`, `docs/validation/soundswitch_hardware_validation_procedure.md`, `docs/validation/soundswitch_hardware_runs/TEMPLATE.md` | **POST-EXAM PARITY STATUS (2026-07-02):** passive-capture registries exist and fresh canonical manifest reports active lanes `algorithm_generalized: 67`, `oracle_proven: 16`, `unverified_parity: 0`; inactive lanes remain `algorithm_generalized: 29`, `oracle_proven: 0`, `unverified_parity: 6`. The offline time-domain exam found scripted/autoloop timing outliers, and the live truth-check exam produced diagnostic byte/timing mismatches while the official comparator was invalid due to capture topology. Current evidence and the one-shot Fable handoff are `docs/research/soundswitch/soundswitch_time_domain_exam_2026_07.md`, `docs/research/soundswitch/soundswitch_truth_exam_live_blockers_2026_07_02.md`, and `docs/prompts/active/soundswitch_truth_exam_fable_fix_prompt.md`. RW-1 through RW-5, native Autoloop DMX, and the non-Autoloop procedure/template are implemented and software-tested, but perfect parity is not proven. No operator hardware evidence run exists; no live config, restart, runtime command, device, output, or hardware action is authorized unless a task explicitly grants it. SOFTWARE/WIRE-VALIDATED ONLY / HARDWARE-UNVALIDATED. |
| AWR-112 | SoundSwitch DMX cue parity | `docs/plans/active/soundswitch_pack_parity_root_cause_spec.md`, `docs/plans/active/soundswitch_pack_render_defect.md`, `docs/plans/active/soundswitch_dmx_cue_mismatch_spec.md` (baseline / negative-control), `docs/research/soundswitch/soundswitch_truth_exam_live_blockers_2026_07_02.md`, `docs/research/soundswitch/soundswitch_time_domain_exam_2026_07.md`, `docs/prompts/active/soundswitch_truth_exam_fable_fix_prompt.md` | **POST-EXAM PERFECT-PARITY TARGET (2026-07-02):** do not reduce parity to the older "3 runtime bugs" reframe. Current evidence packet for Fable includes official comparator invalidity, diagnostic byte/timing mismatches across scripted/autoloop/idle rows, offline scripted/autoloop timing outliers, stale source/capture-source divergences, static-not-covered, playback-edge, seek/rewind, BPM, transition/active-deck, idle/zero-frame, unsupported/inactive/opaque-inventory, and normal-operator-mode gaps. DD42028C remains excluded from operator show coverage and retained as a negative-control witness. No bridge restart, runtime toggle, SoundSwitch export click, canonical-pack overwrite, process-memory sampling, Enttec/DMX, laser, LED/Govee, Rekordbox, or hardware action is authorized by this registry line. SOFTWARE/WIRE-VALIDATED ONLY / HARDWARE-UNVALIDATED. |
