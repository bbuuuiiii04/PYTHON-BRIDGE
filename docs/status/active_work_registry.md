...
| AWR-004 | First bundled agent-workflow dry run | active | Seeded with `docs/agents/operator_workflow.md`; next real feature branch should use one bundled request → agent sorting → implementation → review/repair/handoff and record missing routes, unclear contracts, or token-waste points. |
