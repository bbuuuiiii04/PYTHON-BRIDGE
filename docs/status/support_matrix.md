...
| --- | --- | --- | --- |
| SoundSwitch OS2L | implemented | code path exists; file-driven injector tooling default-off unless explicitly opted in | Exact SoundSwitch version support unknown. |
