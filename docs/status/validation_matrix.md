...
| SoundSwitch OS2L | partial | unvalidated | OS2L output code exists; hardware/app validation log needed. Audit P2 adds default-off injector gating and pack-status `overlay_suppressed` software coverage only. |
