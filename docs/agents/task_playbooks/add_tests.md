...
# Task: adding or reviewing tests

Use when:
- The requested work is specifically about adding or reviewing tests.

Read first:
1. `AGENTS.md`
2. `docs/agents/change_contracts.yml`
3. `docs/subsystems/tests.md`
...
- Inspect `tests/` plus target subsystem files.
...
- `docs/subsystems/tests.md`, software test inventory, validation matrix
