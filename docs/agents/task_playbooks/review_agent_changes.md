...
# Task: reviewing agent-generated changes

Use when:
- The requested work is specifically about reviewing agent-generated changes.

Read first:
1. `AGENTS.md`
2. `docs/agents/change_contracts.yml`
3. `docs/agents/change_contracts.md`
4. `docs/agents/drift_detection.md`
...
- Inspect `git diff`, changed files, related subsystem cards and code.
...
- review notes, status/validation/docs updates if missing
