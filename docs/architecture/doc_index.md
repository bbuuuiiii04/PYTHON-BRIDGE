...
| `docs/plans/active/soundswitch_parity_evidence_finisher_spec.md` | PLAN / SPEC (ACTIVE) | Codex implementation spec for turning the passive parity capture into fixture/oracle/registry evidence. Partially implemented at `871b5f9`: scripted, Autoloop, and Static Look registries exist; Static Looks are generalized; active scripted/Autoloop `unverified_parity` blockers remain. |
