...
| `docs/plans/active/usb_bridge_launcher_design.md` | PLAN / SPEC (ACTIVE — paper phase; re-verified 2026-07-09 at `9ead100`) | macOS-only USB launcher design: PyInstaller bundle, DMG-on-exFAT, stick-is-a-key temporary mode, frame-engine-child freeze risk, ProcessType=Interactive plist rule. Open operator decisions flagged in §1 (Guest-first, $0 cert, replay demo). AWR-122. **Not implemented; build parked on executive gate.** |
