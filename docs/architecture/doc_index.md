...
| `docs/plans/active/docs_orphan_check_spec.md` | PLAN / SPEC (ACTIVE) | Codex spec — add orphan-coverage check to `tools/check_agent_contracts.py`. Tracked as AWR-007. |
