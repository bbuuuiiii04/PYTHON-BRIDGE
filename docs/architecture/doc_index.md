...
| `docs/plans/active/soundswitch_importer_exporter_player_codex_spec.md` | ACTIVE SPEC POINTER | Symlink to the authoritative grouped spec. Task 0 is complete and Task 1's strict offline decoder/frozen models are software-tested for the pinned canonical corpus; Tasks 2–9 remain planned/default-off/hardware-unvalidated. |
