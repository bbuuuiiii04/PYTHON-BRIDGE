...
validation_scope: software-validated only; Rekordbox 7.2.16 direct-reader offsets, RB7216 target-patch/menu/USB-builder hardening including the immediate grey initial-check repaint, native installer guards, and AWR-207 split-local-UUID classification software-tested; physical foreign-Mac patch/attach/install and lighting hardware unvalidated
---
