...
| tests/test_led_identity_v2.py, tests/test_led_color_engine.py, tests/test_color_engine_config.py, tests/test_led_palette_control.py, tests/test_runtime_status.py, tests/test_soundswitch_midi_input.py, tests/test_streamdeck_midi.py | LIGHTING ENGINE v2 F1 identity helpers/store, v1/v2 engine behavior, config gates, Stream Deck zone/manual/max-energy control, runtime commands, MIDI bindings, and deck layout | AWR-128 F1 |
