...
| Phrasing / autoloop / beat / spectral analysis | `smart_phrasing.py`, `smart_rearm.py`, `autoloop_controller.py`, `drop_lifecycle.py`, `beat_math.py`, `audio_spectral_features.py`, `spectral_cache.py`, `spectral_profile.py` | spectral v4: `docs/research/spectral_audio_analysis_redesign.md` |
...
| Offline analysis tooling (no runtime importers) | `energy_model.py`, `tools/analyze_anlz_energy_corpus.py`, `tools/spectral_sweep.py`, `tools/spectral_stick_sweep.py`, `tools/spectral_calibration_report.py` | `docs/research/anlz_energy_project.md`, `docs/research/spectral_audio_analysis_redesign.md`, `docs/research/spectral_calibration_expansion_2026_07_08.md` |
