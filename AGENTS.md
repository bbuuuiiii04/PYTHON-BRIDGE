...
| Offline analysis tooling (no runtime importers) | `energy_model.py`, `tools/analyze_anlz_energy_corpus.py`, `tools/spectral_sweep.py` | `docs/research/anlz_energy_project.md`, `docs/research/spectral_audio_analysis_redesign.md` |
