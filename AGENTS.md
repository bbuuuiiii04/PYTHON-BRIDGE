...
| SoundSwitch pack player / exporter | `soundswitch_pack*.py`, `soundswitch_project_decoder.py`, `soundswitch_parity_oracle.py`, `soundswitch_parity_registry.py`, `soundswitch_scripted_resolution.py`, `soundswitch_static_assertions.py`, `soundswitch_frame_sender.py`, `soundswitch_midi_input.py`, `native_autoloop_resolver.py` | `docs/subsystems/soundswitch_output.md` |
