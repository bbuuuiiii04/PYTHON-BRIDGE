...
| Offline analysis tooling (no runtime importers) | `energy_model.py`, `tools/analyze_anlz_energy_corpus.py`, `tools/spectral_sweep.py`, `tools/spectral_calibration_report.py` | `docs/research/anlz_energy_project.md`, `docs/research/spectral_audio_analysis_redesign.md`, `docs/research/spectral_calibration_expansion_2026_07_08.md` |
