...
payload = {"msg": {"cmd": "razer", "data": {"pt": base64.b64encode(build_dreams_120()).decode('utf-8')}}}
...
print("Continuously sending 120 segments (dreams header). Press Ctrl+C to stop.")
try:
    while True:
